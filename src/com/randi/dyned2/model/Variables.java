...
public class Variables {
	...
	public static final String CONVERSATION_CODE = "GE2";
	public static final String APP_NAME = "General English 2";
	public static final String APP_ID = "100002";

	public static final String SPLASH_NAME = "General English / 2";
